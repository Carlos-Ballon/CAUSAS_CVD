...
```{r}
div(id = "seccion_clinica", renderTable({
  d <- datos_alumno()
  data.frame(
    "Indicador" = c(
      "Nombres y apellidos",
...
```{r}
div(id = "seccion_salud_mental", renderTable({
  d <- datos_alumno()
  data.frame(
    "Indicador" = c(
      "Depresión",
...
div(
  ...
  fluidRow(column(
    ...
    tags$style(
      HTML(
        ".table-condensed { font-size: 13px; }.well { padding: 10px !important; margin-bottom: 0px !important; }"
      )
    ),
